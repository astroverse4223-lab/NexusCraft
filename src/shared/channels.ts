...
export const IPC_CHANNELS = [
  ...
  'resourcepack:serve',
  'resourcepack:hostStatus',
  'resourcepack:stopHost',
  'resourcepack:attach',
  'resourcepack:detach',
  'resourcepack:openPort',
  'resourcepack:closePort',
  'resourcepack:portStatus',
